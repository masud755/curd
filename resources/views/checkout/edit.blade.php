...
@section('content')
  ...
  <div class="row">
    ...
    <div class="col-md-8 order-md-1">
      ...
      <form class="needs-validation" method="POST" action="{{ route('checkout.update', $checkout->id) }}">
        @csrf
        {{ method_field('PUT') }}
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control @error('first_name') is-invalid @enderror "name="first_name"
              id="firstName" placeholder="" value="{{ old('first_name', $checkout->first_name) }}">
            @error('first_name')
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control @error('last_name') is-invalid @enderror " name="last_name"
              id="lastName" placeholder="" value="{{ old('last_name', $checkout->last_name) }}">
            @error('last_name')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
        ...
        <div class="mb-3">
          ...
          <div class="input-group">
            ...
            <input type="text" class="form-control @error('username') is-invalid @enderror "name="username"
              id="username" placeholder="Username" value="{{ old('username', $checkout->username) }}">
            @error('username')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
        ...
        <div class="mb-3">
          ...
          <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" id="email"
            placeholder="you@example.com" value="{{ old('email', $checkout->email) }}">
          @error('email')
            <div class="invalid-feedback">
              {{ $message }}
            </div>
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control @error('address') is-invalid @enderror" name="address" id="address"
            placeholder="1234 Main St" value="{{ old('address', $checkout->address) }}">
          @error('address')
            <div class="invalid-feedback">
              {{ $message }}
            </div>
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="address_2" id="address2" placeholder="Apartment or suite"
            value="{{ old('address_2', $checkout->address_2) }}">
        </div>
        ...
        <div class="row">
          <div class="form-group col-md-5 mb-3">
            ...
            <select class="form-control custom-select d-block w-100 @error('country_id') is-invalid @enderror"
              ...
              @foreach ($countries as $country)
                <option value="{{ $country->id }}" @if (old('country_id', $checkout->country_id) == $country->id) selected @endif>
                  {{ $country->name }}</option>
              @endforeach
            </select>
            @error('country_id')
          ...
          <div class="form-group col-md-4 mb-3">
            ...
            <select class="form-control d-block w-100 @error('state_id') is-invalid @enderror" id="state"
              ...
              @foreach ($states as $state)
                <option value="{{ $state->id }}" @if (old('state_id', $checkout->state_id) == $state->id) selected @endif>
                  {{ $state->name }}</option>
              @endforeach
            </select>
            @error('state_id')
          ...
          <div class="col-md-3 mb-3">
            ...
            <input type="text" name="zip" class="form-control @error('zip') is-invalid @enderror" id="zip"
              placeholder="1234" value="{{ old('zip', $checkout->zip) }}">
            @error('zip')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
